...
def template_model(symvar_type='SX'):
    ...
    _d3 = model.set_variable(var_type='_p', var_name='d3', shape=(1,1))
    _d4 = model.set_variable(var_type='_p', var_name='d4', shape=(1,1))
    ...
    # system model
    A = vertcat(horzcat(1, _d1), horzcat(0, _d2))
    B = vertcat(_d3, _d4)
    x_next =  A @ _x + B @ _u + B @ _e
